...
function setup(){
    ...
    umbrella = new Umbrella(displayWidth/2,displayHeight-200);

    //creating drops
    if(frameCount % 150 === 0){

        for(var i=0; i<maxDrops; i++){
            drops.push(new createDrop(random(0,displayWidth), random(0,displayHeight)));
        }
...
function draw(){
    ...
    if(frameCount%80===0){
        ...
        thunder = createSprite(random(10,displayWidth/2), random(10,30), 10, 10);
        switch(rand){
